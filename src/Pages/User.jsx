...
function User() {
  ...
  return (
    <>
      <div className="text-white w-full mx-auto lg:w-10/12">
        <div className="mb-4">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8 bg-neutral">
          ...
          <div className="col-span-2">
            ...
            <div className="w-full rounded-lg shadow-md bg-neutral stats text-white">
              {location && (
                <div className="stat">
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-neutral stats text-white">
          <div className="stat">
